...
import CardValue from './card-various-offer/cities-card';
import PlacesCard from './card-various-offer/places-card';
import FactoriesCard from './card-various-offer/factories-card';
