...
import {PropsValueCard, Toggle} from '../../types/properties/properties';

const PropertyNotLogged = ((props: PropsValueCard[]): JSX.Element => (
  <div className='page'>
    <Header/>
    <main className='page__main page__main--property'>
      ...
      <div className='container'>
        <section className='near-places places'>
          ...
          <Cards switched={Toggle.citiesCard} cards={props}/>
        </section>
      </div>
    </main>
  </div>
